    ...
    <>
      {modalIsOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="min-h-32 min-w-80 rounded-lg border-2 border-accent bg-white p-4">
            <button
...
function SetupScript({
  ...
  if (mostRecentMessage.includes("Creating virtual environement")) {
    return (
      <div className="flex items-center gap-4 p-4 text-xl">
        <svg
          xmlns="http://www.w3.org/2000/svg"
  ...
  if (mostRecentMessage.includes("Installing required packages...")) {
    return (
      <>
        <div className="flex items-center gap-4 p-4 text-xl">
          <svg
        ...
        <p className="px-4 text-lg opacity-75">
  ...
  return (
    <>
      ...
      <div className="flex items-center gap-4 p-4 text-xl">
        ...
        <p>Required packages installed</p>
      </div>
    </>
  );
}
